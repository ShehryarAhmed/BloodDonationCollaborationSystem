package com.example.a192168328.blooddonationcollaborationsystem;
...
public class signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] location = {"A+", "A-", "B+" ,"B-","O+","O-","AB+","AB-"};

        Spinner sp2 = (Spinner)findViewById(R.id.spinner_splash);
        ArrayAdapter arrayAdapter = new ArrayAdapter(this,R.layout.support_simple_spinner_dropdown_item, location);
